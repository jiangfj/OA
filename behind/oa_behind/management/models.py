...
class Management(models.Model):
    ...
    power = models.CharField('权限',max_length=2,null=True,default='0')
    ...
    position = models.ForeignKey(Position,null=True,default=None,on_delete=models.PROTECT)
    # user = models.OneToOneField(UserProfile,null=True,default=None,on_delete=models.PROTECT)
    def __str__(self):
